...
class CategoriaAPIController extends AppBaseController
{
    ...
    public function store(CreateCategoriaAPIRequest $request)
    {
        ...
        return $this->sendResponse(new CategoriaResource($categoria), 'Categoria saved successfully');
    }
    ...
    public function update($id, UpdateCategoriaAPIRequest $request)
    {
        ...
        return $this->sendResponse(new CategoriaResource($categoria), 'Categoria updated successfully');
    }
