...
class PerguntaAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse(PerguntaResource::collection($perguntas), 'Perguntas retrieved successfully');
    }
    ...
    public function store(CreatePerguntaAPIRequest $request)
    {
        ...
        return $this->sendResponse(new PerguntaResource($pergunta), 'Pergunta saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new PerguntaResource($pergunta), 'Pergunta retrieved successfully');
    }
    ...
    public function update($id, UpdatePerguntaAPIRequest $request)
    {
        ...
        return $this->sendResponse(new PerguntaResource($pergunta), 'Pergunta updated successfully');
    }
